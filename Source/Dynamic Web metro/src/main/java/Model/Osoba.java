...
public class Osoba {
	...
	public Osoba(int idOsobe, String ime, String prezime, String jmbg, int brlk, String datum, int stanje) {
	...
	public Osoba(int id, String ime, String prezime, String jmbg, int brlk, String datum,int ocena, int stanje) {
		this.setIdOsobe(id);
		this.setImeOsobe(ime);
		this.setPrezimeOsobe(prezime);
		this.setJmbgOsobe(jmbg);
